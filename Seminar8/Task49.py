...
4 - Изменить контакт\n5 - Удалить контакт\n6 - Просмотреть все контакты\n0 - Выйти из приложения\n')
        ...
        if user_choice == '1':
            ...
            import_data(file_to_add, telephone_directory)
        elif user_choice == '2':
            contact_list = read_file_to_dict(telephone_directory)
            find_number(contact_list)
        elif user_choice == '3':
            add_phone_number(telephone_directory)
        elif user_choice == '4':
            change_phone_number(telephone_directory)
        elif user_choice == '5':
            delete_contact(telephone_directory)
        elif user_choice == '6':
            show_telephone_directory(telephone_directory)
        elif user_choice == '0':
            print('До свидания!')
            break
        else:
...
def import_data(file_to_add, telephone_directory):
    try:
        with open(file_to_add, 'r', encoding='utf-8') as new_contacts, open(telephone_directory, 'a', encoding='utf-8') as file:
...
def show_telephone_directory(file_name):
